...
import { Target, Users, Sparkles, Code, Linkedin, Github, Twitter, X } from 'lucide-react';
...
const AboutModal: React.FC = () => {
  ...
  const { isAboutModalOpen, closeAboutModal } = useModal();
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-md">
      ...
      <div className="w-full max-w-7xl bg-slate-800/50 backdrop-blur-lg border border-slate-700 shadow-2xl rounded-3xl p-12 z-10 relative max-h-[90vh] overflow-y-auto">
